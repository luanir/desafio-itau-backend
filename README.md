...
* Observações sobre data e hora

O sufixo Z indica que a data e hora estão em UTC (fuso 0).

Todas as datas devem ser enviadas obrigatoriamente em UTC com Z.

Caso esteja utilizando horário local, é necessário ajustar para UTC, somando ou subtraindo horas conforme o fuso.

Exemplos de conversão no Brasil:

Horário de Brasília (UTC-3): somar 3 horas

UTC-4 (AM, RO, RR, MT): somar 4 horas

UTC-5 (AC): somar 5 horas
